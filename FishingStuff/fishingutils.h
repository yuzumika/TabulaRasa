...
#pragma region Types
struct lsbret_t {                       //lose/snap/break return values
    uint8       failReason;
    uint8       chance;
};
...
#define HOURPATTERN_1(x)   (float)std::clamp(0.5f * std::cos(0.82f * x + 0.16f) + 0.5f, 0.0f, 1.0f)
#define HOURPATTERN_2(x)   (float)std::clamp(0.5f * std::cos(0.60f * x + 3.50f) + 0.5f, 0.0f, 1.0f)
#define HOURPATTERN_3(x)   (float)std::clamp(0.5f * std::cos(0.53f * x + 0.00f) + 0.5f, 0.0f, 1.0f)
#define HOURPATTERN_4(x)   (float)std::clamp(0.5f * std::cos(0.23f * x + 3.53f) + 0.5f, 0.0f, 1.0f)

#define MOONPATTERN_1(x)   (float)std::clamp(0.5f * std::cos(1.75f * x + 0.10f) + 0.5f, 0.0f, 1.0f)
#define MOONPATTERN_2(x)   (float)std::clamp(0.5f * std::cos(1.75f * x + 3.30f) + 0.5f, 0.0f, 1.0f)
#define MOONPATTERN_3(x)   (float)std::clamp(1.0f - (x/7)                             , 0.0f, 1.0f)
#define MOONPATTERN_4(x)   (float)std::clamp(0.5f * std::cos(0.90f * x + 3.14f) + 0.5f, 0.0f, 1.0f)
#define MOONPATTERN_5(x)   (float)std::clamp(0.5f * std::cos(0.90f * x + 0.00f) + 0.5f, 0.0f, 1.0f)

#define MONTHPATTERN_1(x)  (float)std::clamp(0.5f * std::cos(0.40f * x - 1.60f) + 0.5f, 0.0f, 1.0f)
#define MONTHPATTERN_2(x)  (float)std::clamp(0.5f * std::cos(0.60f * x - 1.00f) + 0.5f, 0.0f, 1.0f)
#define MONTHPATTERN_3(x)  (float)std::clamp(0.5f * std::cos(0.50f * x + 3.05f) + 0.5f, 0.0f, 1.0f)
#define MONTHPATTERN_4(x)  (float)std::clamp(0.5f * std::cos(1.04f * x + 0.00f) + 0.5f, 0.0f, 1.0f)
#define MONTHPATTERN_5(x)  (float)std::clamp(0.5f * std::cos(0.40f * x + 3.50f) + 0.5f, 0.0f, 1.0f)
#define MONTHPATTERN_6(x)  (float)std::clamp(0.5f * std::cos(0.90f * x - 2.00f) + 0.5f, 0.0f, 1.0f)
#define MONTHPATTERN_7(x)  (float)std::clamp(0.5f * std::cos(0.49f * x + 1.63f) + 0.5f, 0.0f, 1.0f)
#define MONTHPATTERN_8(x)  (float)std::clamp(0.5f * std::cos(1.04f * x - 2.60f) + 0.5f, 0.0f, 1.0f)
#define MONTHPATTERN_9(x)  (float)std::clamp(0.5f * std::cos(0.49f * x - 1.25f) + 0.5f, 0.0f, 1.0f)
#define MONTHPATTERN_10(x) (float)std::clamp(0.5f * std::cos(0.50f * x + 0.53f) + 0.5f, 0.0f, 1.0f)
...
#pragma region FishRankingTypes
